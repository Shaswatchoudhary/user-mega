...
const Womenscare = ({ navigation, route }) => {
  ...
  // Get category from params, default to 'Self-care (Female)'
  const category = route?.params?.category || 'Self-care (Female)';
        ...
        const mappedWorkers = json.data
          .filter(w => {
            ...
            return normalizedWorkerCat === targetCat || 
                   normalizedWorkerCat.includes('womenscare') || 
                   normalizedWorkerCat.includes('femalecare');
          })
          .map(worker => ({
            id: worker._id,
      ...
      <View style={styles.cardContent}>
        <View style={styles.avatarContainer}>
          <View style={styles.avatarPlaceholder}>
            <MaterialCommunityIcons name="face-woman" size={32} color="#9CA3AF" />
          </View>
        </View>
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          <Text style={styles.headerTitle}>Women's Self-Care</Text>
